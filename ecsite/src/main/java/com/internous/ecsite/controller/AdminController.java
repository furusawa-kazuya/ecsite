...
import com.internous.ecsite.model.form.AddUserForm;
...
public class AdminController {
	...
	public boolean checkDuplicatedUserName(@RequestBody String userName) {
		Gson gson = new Gson();
		Map<String, String> map = gson.fromJson(userName, Map.class);
		String name = map.get("userName");
		int count = userRepos.findCountByUserName(name);
		return count > 0;
	}
	...
	public String addUser(@RequestBody AddUserForm addUserForm) {
		...
		user.setFullName(addUserForm.getFullName());
